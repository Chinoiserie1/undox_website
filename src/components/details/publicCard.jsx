export default function PublicCard() {
  ...
  // 204 pages of raw talent and groundbreaking entities.
  // Format : Hardcover – 2 covers of your choice « Black »  or « Purple » , same content.

  // Limited-edition of 200 NTF-Book, each NFT comes w/a physical book.

  // Limited Edition Max 500 copies total – and out of these, 200 will be accompanied by a Non-Fungible Token (NFT), which adds a unique digital aspect to the offering.
    ...
    <div className="py-4 sm:py-10">
      <div className="w-full overflow-hidden border border-white shadow">
        <div className="px-4 py-5 sm:p-6">
          ...
          {/* <h1 className="pt-2 text-2xl font-bold">06.12.2023</h1> */}
          <p
            className="pt-2 font-light text-white/70"
